...
DEFAULT_HOUSEHOLDS = [
    dict(tier="low", base_income=24000, consumption_propensity=0.85, n=4),
    dict(tier="mid", base_income=50000, consumption_propensity=0.65, n=4),
    dict(tier="high", base_income=120000, consumption_propensity=0.45, n=2),
]

DEFAULT_FIRMS = [
    dict(name="Corner Shop", kind="small_shop", price=200.0, wage=220.0,
         unit_cost=120.0, employees=3, max_employees=6, capacity_per_employee=300.0),
    dict(name="Metro Industries", kind="large_firm", price=500.0, wage=280.0,
         unit_cost=300.0, employees=8, max_employees=15, capacity_per_employee=20.0),
]
